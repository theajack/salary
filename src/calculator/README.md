...
```js
{
    afterTaxIncome: [22747.5, 22747.5, 21750, 21575, 21575, 21575, 21575, 21575, 20900, 19900, 19900, 19900],
    afterTaxTotalIncome: 309930,
    afterTaxYearEndAwards: 54210,
    ...
    personalIncomeTax: [502.5, 502.5, 1500, 1675, 1675, 1675, 1675, 1675, 2350, 3350, 3350, 3350],
    preTaxIncome: 30000,
    preTaxTotalIncome: 420000,
    preTaxYearEndAwards: 60000,
    yearEndAwardsPersonalIncomeTax: 5790,
}
```

其中主要的有

afterTaxIncome 表示12个月税后收入

afterTaxTotalIncome 表示年税后总收入(含年终)

afterTaxYearEndAwards 年终奖税后收入

personalIncomeTax 12个月的个税数值
